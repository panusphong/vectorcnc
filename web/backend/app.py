...
def health():
    ...
    return {"ok": True, "service": "VectorCNC",
            ...
            "build": "2026-08-05-stretch",
        "build_note": "ยืดตัวอักษร/สัญลักษณ์แยกแกนได้แล้ว: มือจับส้ม ขวากลาง = ยืดกว้างอย่างเดียว · ล่างกลาง = ยืดสูงอย่างเดียว · มุมน้ำเงิน = ย่อ/ขยายทั้งบรรทัด (ไฟล์ตัดยืดตามที่เห็นบนจอเป๊ะ) · หน้าต่างจัดวางเต็มจอพอดีจอไม่ต้องเลื่อน + ปุ่ม “เสร็จแล้ว/คืนตำแหน่ง” กดติดแล้ว · เส้นเดี่ยว: เชื่อมที่จุดตัดแบบทะลุตรง + เย็บปลายให้บรรจบเป๊ะ · ขนาดที่กรอก = ขนาดแผ่นป้าย โลโก้จัดลงในแผ่นอัตโนมัติ",
