...
def health():
    ...
    return {"ok": True, "service": "VectorCNC",
            ...
            "build": "2026-08-05-price",
        "build_note": "💰 ประเมินราคาหน้าจำลองผนัง: กลุ่มอักษรยกขอบ ไฟออกหน้า/ออกหลัง เคยขึ้น 0 บาท เพราะเอา 'ความสูงทั้งป้าย' ไปตีเป็น 'ความสูงตัวอักษร' แล้วชนเพดาน 60 ซม. — ตอนนี้วัดความสูงตัวอักษรจริงต่อบรรทัด (ผลข้างเคียงที่สำคัญ: ขั้นราคาเคยเลือกผิดขั้น ทำให้ราคาต่ำกว่าจริงหลายเท่า) + ถ้าคิดราคาไม่ได้จะบอกเหตุผลแทนการขึ้น 0 บาทเฉย ๆ · ไดคัทตามตัวอักษร: ลายพิมพ์ทาบ 1:1 กับทรงที่ตัด ไม่ฉลุโบ๋ · พื้นขาวใต้ตัวเลขบอกระยะไม่โดนย้อมสีไฟ",
