...
BUILD_TAG = "2026-08-09-header-badge"
# 📌 สรุปอัปเดตล่าสุดแบบ "หนึ่งบรรทัด" สำหรับโชว์บนหัวเว็บ
#    (build_note ตัวเต็มยาวเป็นหน้ากระดาษ เอาไปขึ้นหัวเว็บไม่ได้)
BUILD_SHORT = "ป้ายบอกแพลน+เวอร์ชันบนหัวเว็บ · สถิติเข้าเว็บเก็บถาวร · ตัดพื้นหลังชิ้นงานอัตโนมัติ · รับไฟล์ .svg แตกชิ้นได้"
