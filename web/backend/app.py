...
def health():
    ...
    return {"ok": True, "service": "VectorCNC",
            ...
            "build": "2026-08-05-kim",
        "build_note": "✂️ แก้เส้นคิ้วโย้ในป้ายใหญ่: ชั้นคิ้วทำ offset บนภาพ แต่ตรึงความละเอียดไว้ 3000px เสมอ ป้ายกว้าง 322 ซม. จึงเหลือ 0.93 พิกเซล/มม. คิ้ว 10 มม. = รัศมี 9 พิกเซล ขอบเลยเป็นคลื่นไม่ขนานตัวอักษร (ป้ายเล็กไม่เจอเพราะได้ 5 พิกเซล/มม. ขึ้นไป) — ตอนนี้ปรับความละเอียดตามขนาดป้ายจริง ≥4 พิกเซล/มม. และถ้ายังไม่พอจะถอยไปใช้ offset แบบเรขาคณิตซึ่งแม่นเป๊ะ · ตรวจแล้ว 19 ประเภทป้าย × 2 ขนาด ผ่านหมด",
