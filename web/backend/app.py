...
BUILD_TAG = "2026-08-09-smooth-knob"
# 📌 สรุปอัปเดตล่าสุดแบบ "หนึ่งบรรทัด" สำหรับโชว์บนหัวเว็บ
#    (build_note ตัวเต็มยาวเป็นหน้ากระดาษ เอาไปขึ้นหัวเว็บไม่ได้)
BUILD_SHORT = "ปุ่มความเนียนของเส้นใช้ได้จริงแล้ว · สถิติรู้ว่าใครเข้ามา · เก็บถาวรบนดิสก์"
